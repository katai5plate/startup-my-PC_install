...
scoop install nvm openssl wget reduce-memory
...
scoop install dotnet5-sdk dotnet6-sdk dotnet7-sdk dotnet-sdl-lts dotnet-nightly tor chromium vcredist xmplay
```
